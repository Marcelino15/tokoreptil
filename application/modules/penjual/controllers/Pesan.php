...
class Pesan extends MY_Controller
{
   ...
   public function hapus()
   {
       ...
       redirect(base_url('penjual/pesan'));
   }
   ...
   public function pesan_masuk()
   {
       ...
       $data['table_view']      = 'pesan';
       $data['fields']          = ['id_pesan', 'judul_pesan', 'email_pesan', 'hp_pesan', 'isi_pesan', 'levelpengirim_pesan', 'status_pesan'];
