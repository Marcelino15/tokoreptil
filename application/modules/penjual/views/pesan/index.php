          ...
          <table id="tabel_pesan" class="display" style="width: 100%">
            ...
            {result}
              <tr>
                ...
                <td>{id_pesan}</td>
                <td>{status_pesan}</td>
                <td><a href="{base_url({level}/pesan/hapus/{id_pesan})}"><span><i class="fa fa-trash"></i></span></a> || 
                <a href="{base_url({level}/pesan/ubah/{id_pesan})}"><span><i class="glyphicon glyphicon-resize-full"></i></span></a></td>
              </tr>
            {/result}
            </tbody>
          </table>
