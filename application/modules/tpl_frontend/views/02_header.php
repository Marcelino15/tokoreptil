			...
			<div class="wrap_header">
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							<li>
								<a href="{base_url(frontend/index)}">Home</a>
							</li>

							<li>
								<a href="{base_url(frontend/shop)}">Reptil</a>
							</li>

							<li>
								<a href="{base_url(frontend/blog)}">Blog</a>
							</li>
				...
				<div class="header-icons">
					<a href="{site_url(global/login/index)}" class="header-wrapicon1 dis-block">
