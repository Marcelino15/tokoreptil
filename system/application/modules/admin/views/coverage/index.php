    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Daftar Lokasi Pesonal</h3>
        ...
        <div class="box-body">
          <table id="tabel_personal" class="display" style="width: 100%">
            <thead>
              <tr>
                <th>ID (searchable)</th>
                <th>Propinsi (searchable)</th>
                <th>Kota/Kabupaten</th>
                <th>Kecamatan(searchable)</th>
            ...
            {result}
              <tr>
                <td>{id_personal}</td>
                <td>{idpropinsi_coverage}</td>
                <td>{idkota_coverage}</td>
                <td>{idkecamatan_coverage}</td>
                <td>
