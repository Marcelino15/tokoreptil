          ...
          <table id="tabel_barang" class="display" style="width: 100%">
            ...
            {result}
              <tr>
                ...
                <td>{nama_barang}</td>
                <td></td>
                <td>{gambar_barang1}</td>
                <td>{gambar_barang2}</td>
                <td>{gambar_barang3}</td>
                <td>{idpersonal_barang}</td>
                <td>{idsubkategori_barang}</td>
                <td>
                  <a href="{base_url({level}/barang/detail/{id_barang})}"><span><i class="glyphicon glyphicon-resize-full"></i></span></a>
                </td>
              </tr>
            {/result}
            </tbody>
